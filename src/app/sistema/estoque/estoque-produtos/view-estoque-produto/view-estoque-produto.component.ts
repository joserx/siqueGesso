...
@Component({
  selector: 'app-view-estoque-produto',
  templateUrl: './view-estoque-produto.component.html',
  styleUrls: ['./view-estoque-produto.component.scss'],
})
export class ViewEstoqueProdutoComponent implements OnInit {
  produtoViewForm = new FormGroup({
  ...
  get fornecedorArray() {
    return this.produtoViewForm.get('fornecedores')! as FormArray;
  }

  ngOnInit(): void {}

  loadForm(produtoInput: any) {
    this.produtoViewForm = new FormGroup({
      destinacao: new FormControl(
